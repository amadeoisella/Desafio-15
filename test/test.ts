    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          ...
          .to.be.equal("62e328337d5c0555986a12a8");
        done();
      });
  });
    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          ...
          .to.be.equal("Invalid ObjectId");
        done();
      });
  });

  it("Should update a product", (done) => {
    const title = `updated product${Math.floor(Math.random() * 100).toString(
      36
    )}`;
    ...
    chai
      ...
      .end((err, res) => {
        ...
        expect(res.body)
          .to.have.property("_id")
          .to.equal("62e328337d5c0555986a12a8");
        done();
      });
  });
